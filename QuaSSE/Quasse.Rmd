...
For the sigmoidal and the hump model we add the parameters for the minimum and maximum values of lambda, along with the inflexion point for the sigmoidal model and the optimal values for the hump model.
